...
"1년 동안 감옥에 갈래, 아니면 수명에서 1년을 잃을래?",
  ...
  //내가 너 말고 다른 사람 만나면 괜찮아?
  //성관계 - 정상위 vs 후배위
  //성관계 - 털 vs 왁싱
  //요즘 나한테 하고 싶었던 말 있어?
  //너한테 '편하다'는 어떤 의미야?
  //성관계 - 한 자세 VS 여러 자세
  //내가 연락 안 하면 먼저 연락할 것 같아?
  //요즘 제일 자주 듣는 노래 뭐야?
  //성관계 - 한번도 안 해본 애인 VS 초고수 애인
  //성관계 - 파트너만 만족시키기 VS 나만 만족하기
  //주 3회 섹스 VS 월 1회 섹스
  //성관계 - 끝나고 같이 샤워하기 VS 각자 샤워 하기
  //썸탈 때 잠자리 가능 VS 불가능
  //성관계 - 나만 오르가즘 VS 상대만 오르가즘
  //내가 오늘 웃게 만든 순간 있어?
  //스트레스 받을 때 어떻게 풀어?
  //선섹후사 어떻게 생각해?
  //만약에 나랑 사귀면 어떨 것 같아?
  ...
  //나랑 해보고 싶은 거 있어?
  //내가 하는 가장 설레는 행동은 뭐야?ㄹ
  //요즘 연락 제일 많이 하는 사람 누구야?
  //성관계 - 애인이 위 VS 애인이 아래
  //내가 다른 사람 좋아한다고 하면 어떨 것 같아?
  //친구와 섹스하기 VS 모르는 사람과 섹스하기
  ...
  //난 네 이상형에 몇% 부합해?
  //내가 갑자기 손 잡으면 뺄 거야?
  //성관계 - 끊임없는 신음 소리 VS 절대 소리 내면 안 됨
  //자위하다 부모님께 걸리기 VS 섹스하다 부모님께 걸리기
  //애무 받을때 가장 좋았던 곳은?
  //내가 너한테 어떤 존재 같아?
  //유두 VS 클리
  //내 생각 하면서 혼자 자위 한적 있어?
  //나랑 더 가까워지고 싶다고 느낀 적 있어?
  //내가 고백하면 고민은 할 거야 아니면 바로 거절할 거야?
  //성관계 - 불 키고 vs 불 끄고
  //성관계 - 기구 사용 하기 VS 기구 사용 안 하기
  //솔직하게 나랑 섹스하는 상상해 본 적 있어?
  //요즘 가장 먹고 싶은 음식은?
  //성관계 - 옷 입은 채로 하기 VS 완전히 벗고 하기
  //나랑 사귀면 가장 걱정되는 건?
  //나 웃길 때랑 진지할 때 중 뭐가 더 좋아?
  //샤워 후 섹스 VS 섹스 전 샤워
  //삽입 VS 애무
  //양치 안하고 키스 VS 샤워 안하고 섹스
  //성관계 - 대놓고 내지르는 신음 소리 vs 참다가 새어나온 신음 소리
  //성관계 - 짧게 여러번 VS 길게 한번
  //성관계 - 입에다가 사정 VS 몸에다가 사정
  //처음 본 사람과 원나잇 VS 오랜 절친과 원나잇
  //성관계 - 손만 사용 가능 VS 입만 사용 가능
  //내가 있으면 하루가 더 즐거워?
  //최근에 야동 언제 봤어?
  //오늘 가장 웃겼던 일 뭐였어?
  //성욕이 너무 강한 애인 VS 성욕이 없는 애인
  //내가 보고 싶다고 하면?
  //야동보다 썸한테 걸리기 VS 엄마한테 걸리기
  //나한테 궁금한 19금 질문 한가지
  //지금까지 했던거 뺴고 나랑 해보고 싶은 거 있어?(19금)
  //나랑 같이 여행 가면 몇 박 가능해?
  //나한테 가장 최근에 한 거짓말 뭐야?
  ...
  //"우리 둘이 잘 맞는 편 같아?",
  //"나랑 사소한 다툼 생기면?",
  //"나랑 하고싶은데 아직 말 못한 거 있어?",
  //"내가 고백하면 받아줄 가능성은?",
  //"나를 좋아하려다 참는 느낌이야 아니면 애초에 감정이 없어?",
  //"내가 떠나면 잡을 거야?",
  //"나랑 하루 연락 안 하면 어떤 기분일 것 같아?",
  //"나를 안아보고 싶다는 생각 해봤어?",
  //"나를 보면 눈 어디부터 볼 것 같아?",
  //"나한테 설렌 순간 그게 언제야?",
  ...
  //"성관계 - 소리만 들으며 VS 소리 없이 보기만 하면서",
  //"아침 섹스 VS 저녁 섹스",
  //"치마 VS 바지",
  //"19 - 애무만 가능 VS 삽입만 가능",
  //"주사가 뭐야?",
  //"가족 뺴고 다른 사람과 1년을 함께 보내야 한다면 누구를 선택하시겠어요?(이성)",
  //"만약 복권에 당첨돼서 10억을 받게 되면 어떻게 쓰실 건가요?",
  //"나랑 연락 하면서 일부러 밀당한 적 있어?",
  //"너만의 밀당 스킬 하나만 얘기해줘봐.",
  //"넌 어떤 사람한테 매력을 느껴?",
  //"내가 사귀자고 하면 나랑 사귈 마음 있어?",
  //"나한테 질투 느낀적 있어? 있다면 그게 언제야?",
  //"우리가 만났을때 오늘 내가 집에 가지 말라고 하면, 집에 안 갈 거야?",
  //"손 잡고 자기 VS 꼭 안고 자기",
  //"질투하는 모습 보기 VS 내가 살짝 질투하기",
  //"질투 심한 연인 VS 무관심한 연인",
  //"사랑하는 사람보다 하루 먼저 죽기 VS 하루 늦게 죽기",
